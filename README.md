...
```
dfx canister call opend listItem '(principal "sp3hj-caaaa-aaaaa-aaajq-cai", 2)'
```
...
```
dfx canister call sp3hj-caaaa-aaaaa-aaajq-cai transferowner '(principal "ryjl3-tyaaa-aaaaa-aaaba-cai", true)'
```
